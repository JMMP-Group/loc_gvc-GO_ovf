...
DOMCFG_MEs = base_dir + '/loc_gvc-nordic_ovf/models_geometry/dom_cfg/realistic/vqs/domain_cfg_vqs.nc'
...
mpl_sec_loop('ORCA025-locvqs mesh', '.png', var_strng, unit_strng, date, timeres_dm, timestep, PlotType,
